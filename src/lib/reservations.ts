...
import { 
  ...
  hasActiveReservation as hasCubiculosActiveReservation,
...
// Función para verificar si una matrícula tiene una reserva activa
export function hasActiveReservation(matricula: string): boolean {
  return hasCubiculosActiveReservation(matricula)
}
